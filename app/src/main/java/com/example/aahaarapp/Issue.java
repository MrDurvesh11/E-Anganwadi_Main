...
public class Issue extends AppCompatActivity {
    ...
    String str_name, str_email, str_subject, str_issue, str_mobile, mobile_str;
    Button sbt;
    ...
    public void sendSms() {
        ...
        smsManager.sendTextMessage(mobile_str, null, "Thank you for your feedback. We will get back to you soon.", null, null);
        Toast.makeText(Issue.this, "SMS Send Successfully", Toast.LENGTH_SHORT).show();
    }
}
